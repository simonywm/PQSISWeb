...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row border border-secondary p-4">
            <div class="col-md-12" style="text-align:center">
                Incident Case Upload
            </div>
            <div class="col-md-12">
                <br />
                <b> Report Path: <?php echo dirname(dirname(__dir__)) . '/upload/incident/waiting/' ?> </b>
                <br />
    ...
    $(function() {
        ...
        $("#uploadBtn").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Function/IncidentReportUpload",
                type: "POST",
                cache: false,
                data: '',
