...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-9">
                    <h3>Export Planning Ahead Project Response Rate from Project Owner</h3>
                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <table id="Table" width="100%" style="white-space:nowrap;" class="display">
                ...
                <tr>
                    <td>Date Range</td>
                    <td>Project Owner’s Company Name</td>
                    <td>Project Owner’s Response Rate on Reply Slip</td>
                    <td>Project Owner’s Response Rate on Meeting</td>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    $(document).ready(function(){
        ...
        table = $("#Table").DataTable({
            ...
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=PlanningAhead/AjaxGetExportResponseRateFromProjectOwner",
                "type": "POST",
