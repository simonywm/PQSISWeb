        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Service Status Id <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="serviceStatusId" name="serviceStatusId" type="text" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label> Service Status Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="serviceStatusName" name="serviceStatusName" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label>show Order in Form <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateServiceStatus",
            type: "POST",
            cache: false,
    ...
    $("#serviceStatusId").val("<?php echo $this->viewbag['serviceStatus']['serviceStatusId']?>");
    $("#serviceStatusName").val("<?php echo $this->viewbag['serviceStatus']['serviceStatusName']?>");
    $("#showOrder").val("<?php echo $this->viewbag['serviceStatus']['showOrder']?>");
    $("#active").val("<?php echo $this->viewbag['serviceStatus']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertServiceStatus",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#serviceStatusName").val() == "") {
            if (errorMessage == "")
                $("#serviceStatusName").focus();
            errorMessage = errorMessage + "Error " + i + ": " + "Action By Name can not be blank <br/>";
            i = i + 1;
            $("#serviceStatusName").addClass("invalid");
        }
        if ($("#txActive").val() == "") {
            if (errorMessage == "")
                $("#txActive").focus();
    ...
    /* $("#btnServiceStatusCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
