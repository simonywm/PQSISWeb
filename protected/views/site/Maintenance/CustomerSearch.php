...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="customerIdSearchTxt" name="customerIdSearchTxt" type="number" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="customerNameSearchTxt" name="customerNameSearchTxt" type="text" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="customerGroupSearchTxt" name="customerGroupSearchTxt" type="text" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetCustomerTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.customerId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  customerId='" +
                            row.customerId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#customerIdSearchTxt").val() != null && $("#customerIdSearchTxt").val() != "") {
            searchParamStr += "\"customerId\":" + "\"" + $("#customerIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#customerNameSearchTxt").val() != null && $("#customerNameSearchTxt").val() != "") {
            searchParamStr += "\"customerName\":" + "\"" + $("#customerNameSearchTxt").val() + "\"" + ",";
        }
        if ($("#customerGroupSearchTxt").val() != null && $("#customerGroupSearchTxt").val() != "") {
            searchParamStr += "\"customerGroup\":" + "\"" + $("#customerGroupSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetCustomerForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetCustomerForUpdate&customerId=" +
