<script>
$(function() {
    $("#bMenuMaintenanceLinkRP").addClass("active");
...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="regionPlannerIdSearchTxt" name="regionPlannerIdSearchTxt" type="number" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="regionPlannerNameSearchTxt" name="regionPlannerNameSearchTxt" type="text"
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Region Planner Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetRegionPlannerTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.regionPlannerId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  regionPlannerId='" +
                            row.regionPlannerId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#regionPlannerIdSearchTxt").val() != null && $("#regionPlannerIdSearchTxt").val() != "") {
            searchParamStr += "\"regionPlannerId\":" + "\"" + $("#regionPlannerIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#regionPlannerNameSearchTxt").val() != null && $("#regionPlannerNameSearchTxt").val() != "") {
            searchParamStr += "\"regionPlannerName\":" + "\"" + $("#regionPlannerNameSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetRegionPlannerForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetRegionPlannerForUpdate&regionPlannerId=" +
                    $(this).attr("regionPlannerId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
