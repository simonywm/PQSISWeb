<script>
$(function() {
    $("#bMenuMaintenanceLinkPT").addClass("active");
...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="projectTypeIdSearchTxt" name="projectTypeIdSearchTxt" type="number" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="projectTypeNameSearchTxt" name="projectTypeNameSearchTxt" type="text" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Project Type Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetProjectTypeTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.projectTypeId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  projectTypeId='" +
                            row.projectTypeId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#projectTypeIdSearchTxt").val() != null && $("#projectTypeIdSearchTxt").val() != "") {
            searchParamStr += "\"projectTypeId\":" + "\"" + $("#projectTypeIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#projectTypeNameSearchTxt").val() != null && $("#projectTypeNameSearchTxt").val() != "") {
            searchParamStr += "\"projectTypeName\":" + "\"" + $("#projectTypeNameSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetProjectTypeForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetProjectTypeForUpdate&projectTypeId=" +
                    $(this).attr("projectTypeId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
