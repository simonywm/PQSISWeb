    ...
    <div class="card border border-secondary">
        <form id="Form" onsubmit=>
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-8">
                        <h3>Requested By Update</h3>
                    </div>
                    <div class="col-lg-4" style="text-align:right">

                        <button id="btnApply" name="btnApply" type="button"
                            class="btn btn-primary btnFormApply">Update</button>
                ...
                <div class="row" hidden>
                    ...
                    <div class="col-md-7">
                        <input id="txRequestedById" name="txRequestedById" type="text" class="form-control"
                            placeholder="" value="<?php echo $this->viewbag['requestedBy']['requestedById'] ?>"
                            readonly />
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input id="txRequestedByName" name="txRequestedByName" type="text" class="form-control"
                            placeholder="" value="<?php echo $this->viewbag['requestedBy']['requestedByName'] ?>">
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label>CLP Person Department <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="txRequestedByDept" name="txRequestedByDept" type="text" class="form-control"
                            placeholder="" value="<?php echo $this->viewbag['requestedBy']['requestedByDept'] ?>">
                    </div>
                </div>
                <br />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-left:5px">
                        <select id="txActive" name="txActive" style="height:30px;width:100%">
                            <?php if ($this->viewbag['requestedBy']['active'] == 'Y') {?>
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateRequestedBy",
            type: "POST",
            cache: false,
