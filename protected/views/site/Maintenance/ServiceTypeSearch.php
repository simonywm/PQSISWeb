...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="serviceTypeIdSearchTxt" name="serviceTypeIdSearchTxt" type="number" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="serviceTypeNameSearchTxt" name="serviceTypeNameSearchTxt" type="text" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Service Type Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetServiceTypeTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.serviceTypeId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  serviceTypeId='" +
                            row.serviceTypeId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#serviceTypeIdSearchTxt").val() != null && $("#serviceTypeIdSearchTxt").val() != "") {
            searchParamStr += "\"serviceTypeId\":" + "\"" + $("#serviceTypeIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#serviceTypeNameSearchTxt").val() != null && $("#serviceTypeNameSearchTxt").val() != "") {
            searchParamStr += "\"serviceTypeName\":" + "\"" + $("#serviceTypeNameSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetServiceTypeForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetServiceTypeForUpdate&serviceTypeId=" +
                    $(this).attr("serviceTypeId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
