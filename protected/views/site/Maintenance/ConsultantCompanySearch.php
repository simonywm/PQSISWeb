<script>
$(function() {
    $("#bMenuMaintenanceLinkCC").addClass("active");
...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="consultantCompanyIdSearchTxt" name="consultantCompanyIdSearchTxt" type="number"
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="consultantCompanyNameSearchTxt" name="consultantCompanyNameSearchTxt" type="text"
                    class="form-control" placeholder="" />
            </div>
        </div>
        <br />
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetConsultantCompanyTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.consultantCompanyId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  consultantCompanyId='" +
                            row.consultantCompanyId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#consultantCompanyIdSearchTxt").val() != null && $("#consultantCompanyIdSearchTxt").val() != "") {
            searchParamStr += "\"consultantCompanyId\":" + "\"" + $("#consultantCompanyIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#consultantCompanyNameSearchTxt").val() != null && $("#consultantCompanyNameSearchTxt").val() != "") {
            searchParamStr += "\"consultantCompanyName\":" + "\"" + $("#consultantCompanyNameSearchTxt").val() + "\"" +
                ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetConsultantCompanyForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetConsultantCompanyForUpdate&consultantCompanyId=" +
                    $(this).attr("consultantCompanyId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
