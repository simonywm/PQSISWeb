        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Project Region Id <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="projectRegionId" name="projectRegionId" type="text" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label> Project Region English Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="projectRegionEngName" name="projectRegionEngName" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label> Project Region Chinese Name </label>

                    </div>
                    <div class="col-md-7">
                        <input id="projectRegionChiName" name="projectRegionChiName" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateProjectRegion",
            type: "POST",
            cache: false,
    ...
    $("#projectRegionId").val("<?php echo $this->viewbag['projectRegion']['projectRegionId']?>");
    $("#projectRegionEngName").val("<?php echo $this->viewbag['projectRegion']['projectRegionEngName']?>");
    $("#projectRegionChiName").val("<?php echo $this->viewbag['projectRegion']['projectRegionChiName']?>");
    $("#active").val("<?php echo $this->viewbag['projectRegion']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertProjectRegion",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#projectRegionEngName").val() == "") {
            if (errorMessage == "")
                $("#projectRegionEngName").focus();
            errorMessage = errorMessage + "Error " + i + ": " + "Project Region Name can not be blank <br/>";
            i = i + 1;
            $("#projectRegionEngName").addClass("invalid");
        }
        if ($("#active").val() == "") {
            if (errorMessage == "")
                $("#active").focus();
    ...
    /* $("#btnProjectRegionCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
