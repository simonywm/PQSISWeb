<script>
$(function() {
    $("#aMenuMaintenanceLinkMAE").addClass("active");
...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            <div class="col-md-3">
                Major Affected Element Id
            </div>
            <div class="col-md-9">
                <input id="majorAffectedElementIdSearchTxt" name="majorAffectedElementIdSearchTxt" type="number"
        ...
        <div class="row">
            <div class="col-md-3">
                Major Affected Element Name
            </div>
            <div class="col-md-9">
                <input id="majorAffectedElementNameSearchTxt" name="majorAffectedElementNameSearchTxt" type="text"
                    class="form-control" placeholder="" />
            </div>
        </div>
        <br />
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Major Affected Element Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetMajorAffectedElementTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.majorAffectedElementId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  majorAffectedElementId='" +
                            row.majorAffectedElementId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#majorAffectedElementIdSearchTxt").val() != null && $("#majorAffectedElementIdSearchTxt").val() != "") {
            searchParamStr += "\"majorAffectedElementId\":" + "\"" + $("#majorAffectedElementIdSearchTxt").val() +
                "\"" + ",";
        }

        if ($("#majorAffectedElementNameSearchTxt").val() != null && $("#majorAffectedElementNameSearchTxt").val() !=
            "") {
            searchParamStr += "\"majorAffectedElementName\":" + "\"" + $("#majorAffectedElementNameSearchTxt").val() +
                "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetMajorAffectedElementForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetMajorAffectedElementForUpdate&majorAffectedElementId=" +
                    $(this).attr("majorAffectedElementId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
