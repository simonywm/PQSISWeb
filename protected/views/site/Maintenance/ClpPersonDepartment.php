        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    ...
                    <div class="col-md-7">
                        <input id="clpPersonDepartmentId" name="clpPersonDepartmentId" type="text" class="form-control"
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input id="clpPersonDepartmentName" name="clpPersonDepartmentName" type="text"
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateClpPersonDepartment",
            type: "POST",
            cache: false,
    ...
    $("#clpPersonDepartmentId").val(
        "<?php echo $this->viewbag['clpPersonDepartment']['clpPersonDepartmentId']?>");
    $("#clpPersonDepartmentName").val(
        "<?php echo $this->viewbag['clpPersonDepartment']['clpPersonDepartmentName']?>");
    $("#active").val("<?php echo $this->viewbag['clpPersonDepartment']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertClpPersonDepartment",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#clpPersonDepartmentName").val() == "") {
            if (errorMessage == "")
                $("#clpPersonDepartmentName").focus();
            errorMessage = errorMessage + "Error " + i + ": " +
                "Clp Person Department Name can not be blank <br/>";
            i = i + 1;
            $("#clpPersonDepartmentName").addClass("invalid");
        }
        if ($("#active").val() == "") {
            if (errorMessage == "")
                $("#active").focus();
    ...
    /* $("#btnClpPersonDepartmentCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
