        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Action ById <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="actionById" name="actionById" type="text" class="form-control" placeholder=""
                            value="" readonly />
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label> Action By Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="actionByName" name="actionByName" type="text" class="form-control" placeholder=""
                            value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateActionBy",
            type: "POST",
            cache: false,
    ...
    $("#actionById").val("<?php echo $this->viewbag['actionBy']['actionById']?>");
    $("#actionByName").val("<?php echo $this->viewbag['actionBy']['actionByName']?>");
    $("#active").val("<?php echo $this->viewbag['actionBy']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertActionBy",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    /* $("#btnActionByCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
