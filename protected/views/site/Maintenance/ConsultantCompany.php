<script>
$(function() {
    $("#aMenuMaintenanceLinkCC").addClass("active");
    ...
    <div class="card border border-secondary">
        <form id="Form" onsubmit=>
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 id="title"> Consultant Company </h3>
                    </div>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Consultant Company Id <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="consultantCompanyId" name="consultantCompanyId" type="text" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label> Consultant Company Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="consultantCompanyName" name="consultantCompanyName" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateConsultantCompany",
            type: "POST",
            cache: false,
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertConsultantCompany",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#consultantCompanyName").val() == "") {
            if (errorMessage == "")
                $("#consultantCompanyName").focus();
            errorMessage = errorMessage + "Error " + i + ": " +
                "Consultant Company Name can not be blank <br/>";
            i = i + 1;
            $("#consultantCompanyName").addClass("invalid");
        }
        if ($("#active").val() == "") {
            if (errorMessage == "")
                $("#active").focus();
    ...
    /* $("#btnConsultantCompanyCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
