        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>ConfigId <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="txConfigId" name="txConfigId" type="text" class="form-control" placeholder=""
                            value="" readonly />
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label> Config Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="txConfigName" name="txConfigName" type="text" class="form-control" placeholder=""
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input id="txConfigValue" name="txConfigValue" type="text" class="form-control" placeholder=""
                            value="">
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label>Config Dsecription <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="txConfigDescription" name="txConfigDescription" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateConfig",
            type: "POST",
            cache: false,
    ...
    $("#txConfigId").val("<?php echo $this->viewbag['config']['configId']?>");
    $("#txConfigName").val("<?php echo $this->viewbag['config']['configName']?>");
    $("#txConfigValue").val("<?php echo $this->viewbag['config']['configValue']?>");
    $("#txConfigDescription").val("<?php echo $this->viewbag['config']['configDescription']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertConfig",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#txConfigDate").val() == "") {
            if (errorMessage == "")
                $("#txConfigDate").focus();
            errorMessage = errorMessage + "Error " + i + ": " + "Config Date can not be blank <br/>";
            i = i + 1;
            $("#txConfigDept").addClass("invalid");
        }
        if ($("#txActive").val() == "") {
            if (errorMessage == "")
                $("#txActive").focus();
    ...
    /* $("#btnConfigCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
