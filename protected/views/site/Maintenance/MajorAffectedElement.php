    ...
    <div class="card border border-secondary">
        <form id="Form" onsubmit=>
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 id="title"> Major Affected Element </h3>
                    </div>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Major Affected ElementId <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="majorAffectedElementId" name="majorAffectedElementId" type="text"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label> Major Affected Element Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="majorAffectedElementName" name="majorAffectedElementName" type="text"
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateMajorAffectedElement",
            type: "POST",
            cache: false,
    ...
    $("#majorAffectedElementId").val(
        "<?php echo $this->viewbag['majorAffectedElement']['majorAffectedElementId']?>");
    $("#majorAffectedElementName").val(
        "<?php echo $this->viewbag['majorAffectedElement']['majorAffectedElementName']?>");
    $("#active").val("<?php echo $this->viewbag['majorAffectedElement']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertMajorAffectedElement",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#majorAffectedElementName").val() == "") {
            if (errorMessage == "")
                $("#majorAffectedElementName").focus();
            errorMessage = errorMessage + "Error " + i + ": " +
                "Major Affected Element Name can not be blank <br/>";
            i = i + 1;
            $("#majorAffectedElementName").addClass("invalid");
        }
        if ($("#active").val() == "") {
            if (errorMessage == "")
                $("#active").focus();
    ...
    /* $("#btnMajorAffectedElementCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
