        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Plant Type Id <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="plantTypeId" name="plantTypeId" type="text" class="form-control" placeholder=""
                            value="" readonly />
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label> Plant Type Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="plantTypeName" name="plantTypeName" type="text" class="form-control" placeholder=""
                            value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdatePlantType",
            type: "POST",
            cache: false,
    ...
    $("#plantTypeId").val("<?php echo $this->viewbag['plantType']['plantTypeId']?>");
    $("#plantTypeName").val("<?php echo $this->viewbag['plantType']['plantTypeName']?>");
    $("#active").val("<?php echo $this->viewbag['plantType']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertPlantType",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    /* $("#btnPlantTypeCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
