<script>
$(function() {
    $("#aMenuMaintenanceLinkCPD").addClass("active");
...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            <div class="col-md-3">
                Clp Person Department Id
            </div>
            <div class="col-md-9">
                <input id="clpPersonDepartmentIdSearchTxt" name="clpPersonDepartmentIdSearchTxt" type="number"
        ...
        <div class="row">
            <div class="col-md-3">
                Clp Person Department Name
            </div>
            <div class="col-md-9">
                <input id="clpPersonDepartmentNameSearchTxt" name="clpPersonDepartmentNameSearchTxt" type="text"
                    class="form-control" placeholder="" />
            </div>
        </div>
        <br />
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Clp Person Department Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetClpPersonDepartmentTable",
                "type": "POST",
            ...
            "columns": [
                ...
                {
                    "data": "clpPersonDepartmentId",
                    "width": "10%"
                },
                {
                    "data": "clpPersonDepartmentName",
                    "width": "20%"
                },
                {
                    "data": "active",
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.clpPersonDepartmentId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  clpPersonDepartmentId='" +
                            row.clpPersonDepartmentId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#clpPersonDepartmentIdSearchTxt").val() != null && $("#clpPersonDepartmentIdSearchTxt").val() != "") {
            searchParamStr += "\"clpPersonDepartmentId\":" + "\"" + $("#clpPersonDepartmentIdSearchTxt").val() + "\"" +
                ",";
        }

        if ($("#clpPersonDepartmentNameSearchTxt").val() != null && $("#clpPersonDepartmentNameSearchTxt").val() !=
            "") {
            searchParamStr += "\"clpPersonDepartmentName\":" + "\"" + $("#clpPersonDepartmentNameSearchTxt").val() +
                "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetClpPersonDepartmentForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetClpPersonDepartmentForUpdate&clpPersonDepartmentId=" +
                    $(this).attr("clpPersonDepartmentId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
