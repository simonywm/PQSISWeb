        ...
        <form id="Form" onsubmit=>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Contact PersonId <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="contactPersonId" name="contactPersonId" type="text" class="form-control"
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input id="contactPersonTitle" name="contactPersonTitle" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <input id="contactPersonNo" name="contactPersonNo" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdateContactPerson",
            type: "POST",
            cache: false,
    ...
    $("#contactPersonId").val("<?php echo $this->viewbag['contactPerson']['contactPersonId']?>");
    $("#contactPersonName").val("<?php echo $this->viewbag['contactPerson']['contactPersonName']?>");
    $("#contactPersonTitle").val("<?php echo $this->viewbag['contactPerson']['contactPersonTitle']?>");
    $("#contactPersonNo").val("<?php echo $this->viewbag['contactPerson']['contactPersonNo']?>");
    $("#active").val("<?php echo $this->viewbag['contactPerson']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertContactPerson",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#contactPersonName").val() == "") {
            ...
            errorMessage = errorMessage + "Error " + i + ": " + "Contact Person Name can not be blank <br/>";
            i = i + 1;
    ...
    /* $("#btnContactPersonCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
