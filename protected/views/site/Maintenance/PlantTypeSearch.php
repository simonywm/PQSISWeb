...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="plantTypeIdSearchTxt" name="plantTypeIdSearchTxt" type="number" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="plantTypeNameSearchTxt" name="plantTypeNameSearchTxt" type="text" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Plant Type Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetPlantTypeTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.plantTypeId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  plantTypeId='" +
                            row.plantTypeId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#plantTypeIdSearchTxt").val() != null && $("#plantTypeIdSearchTxt").val() != "") {
            searchParamStr += "\"plantTypeId\":" + "\"" + $("#plantTypeIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#plantTypeNameSearchTxt").val() != null && $("#plantTypeNameSearchTxt").val() != "") {
            searchParamStr += "\"plantTypeName\":" + "\"" + $("#plantTypeNameSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetPlantTypeForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetPlantTypeForUpdate&plantTypeId=" +
                    $(this).attr("plantTypeId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
