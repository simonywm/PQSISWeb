...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="clpReferredByIdSearchTxt" name="clpReferredByIdSearchTxt" type="number" class="form-control"
                    placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-md-3">
                clp Referred By Name
            </div>
            <div class="col-md-9">
                <input id="clpReferredByNameSearchTxt" name="clpReferredByNameSearchTxt" type="text"
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">clp Referred By Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetClpReferredByTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.clpReferredById +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  clpReferredById='" +
                            row.clpReferredById + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#clpReferredByIdSearchTxt").val() != null && $("#clpReferredByIdSearchTxt").val() != "") {
            searchParamStr += "\"clpReferredById\":" + "\"" + $("#clpReferredByIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#clpReferredByNameSearchTxt").val() != null && $("#clpReferredByNameSearchTxt").val() != "") {
            searchParamStr += "\"clpReferredByName\":" + "\"" + $("#clpReferredByNameSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetClpReferredByForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetClpReferredByForUpdate&clpReferredById=" +
                    $(this).attr("clpReferredById"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
