<script>
$(function() {
    $("#aMenuMaintenanceLinkPTBC").addClass("active");
    ...
    <div class="card border border-secondary">
        <form id="Form" onsubmit=>
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 id="title"> Party To Be Charged </h3>
                    </div>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>Party To Be Charged Id <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="partyToBeChargedId" name="partyToBeChargedId" type="text" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label> Party To Be Charged Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="partyToBeChargedName" name="partyToBeChargedName" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-5">
                        <label>show Order in Report </label>
                    </div>
                    <div class="col-md-7">
                        <input id="showOrder" name="showOrder" type="number" class="form-control" placeholder=""
                            value="" />
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdatePartyToBeCharged",
            type: "POST",
            cache: false,
    ...
    $("#partyToBeChargedId").val("<?php echo $this->viewbag['partyToBeCharged']['partyToBeChargedId']?>");
    $("#partyToBeChargedName").val("<?php echo $this->viewbag['partyToBeCharged']['partyToBeChargedName']?>");
    $("#showOrder").val("<?php echo $this->viewbag['partyToBeCharged']['showOrder']?>");
    $("#active").val("<?php echo $this->viewbag['partyToBeCharged']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertPartyToBeCharged",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#partyToBeChargedName").val() == "") {
            if (errorMessage == "")
                $("#partyToBeChargedName").focus();
            errorMessage = errorMessage + "Error " + i + ": " +
                "Party To Be Charged Name can not be blank <br/>";
            i = i + 1;
            $("#partyToBeChargedName").addClass("invalid");
        }
        if ($("#active").val() == "") {
            if (errorMessage == "")
                $("#active").focus();
    ...
    /* $("#btnPartyToBeChargedCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
