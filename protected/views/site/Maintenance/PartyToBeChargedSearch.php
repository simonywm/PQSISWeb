...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            <div class="col-md-3">
                Party To Be Charged Id
            </div>
            <div class="col-md-9">
                <input id="partyToBeChargedIdSearchTxt" name="partyToBeChargedIdSearchTxt" type="number"
        ...
        <div class="row">
            <div class="col-md-3">
                Party To Be Charged Name
            </div>
            <div class="col-md-9">
                <input id="partyToBeChargedNameSearchTxt" name="partyToBeChargedNameSearchTxt" type="text"
                    class="form-control" placeholder="" />
            </div>
        </div>
        <br />
            ...
            <table id="Table" width="100%" class="display no-wrap">
                <thead>
                    <tr>
                        ...
                        <td width="10%">ID </td>
                        <td width="10%">Party To Be Charged Name </td>
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetPartyToBeChargedTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.partyToBeChargedId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  partyToBeChargedId='" +
                            row.partyToBeChargedId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#partyToBeChargedIdSearchTxt").val() != null && $("#partyToBeChargedIdSearchTxt").val() != "") {
            searchParamStr += "\"partyToBeChargedId\":" + "\"" + $("#partyToBeChargedIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#partyToBeChargedNameSearchTxt").val() != null && $("#partyToBeChargedNameSearchTxt").val() != "") {
            searchParamStr += "\"partyToBeChargedName\":" + "\"" + $("#partyToBeChargedNameSearchTxt").val() + "\"" +
                ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetPartyToBeChargedForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetPartyToBeChargedForUpdate&partyToBeChargedId=" +
                    $(this).attr("partyToBeChargedId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
                success: function(data) {
