<script>
$(function() {
    $("#aMenuMaintenanceLinkPSL").addClass("active");
    ...
    <div class="card border border-secondary">
        <form id="Form" onsubmit=>
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-8">
                        <h3 id="title"> PQSensitive Load </h3>
                    </div>
            ...
            <div class="card-body">
                <div class="row" id="idDiv">
                    <div class="col-md-5">
                        <label>PQSensitive Load Id <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-7">
                        <input id="pqSensitiveLoadId" name="pqSensitiveLoadId" type="text" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label> PQSensitive Load Name <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-md-7">
                        <input id="pqSensitiveLoadName" name="pqSensitiveLoadName" type="text" class="form-control"
                            placeholder="" value="">
                    </div>
                </div>
                <br />
...
$(document).ready(function() {
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxUpdatePqSensitiveLoad",
            type: "POST",
            cache: false,
    ...
    $("#pqSensitiveLoadId").val("<?php echo $this->viewbag['pqSensitiveLoad']['pqSensitiveLoadId']?>");
    $("#pqSensitiveLoadName").val("<?php echo $this->viewbag['pqSensitiveLoad']['pqSensitiveLoadName']?>");
    $("#active").val("<?php echo $this->viewbag['pqSensitiveLoad']['active']?>");
    ...
    $("#btnApply").unbind().bind("click", function() {
        ...
        $.ajax({
            url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxInsertPqSensitiveLoad",
            type: "POST",
            cache: false,
            data: $("#Form").serializeArray(),
            success: function(data) {
    ...
    function validateInput() {
        ...
        if ($("#pqSensitiveLoadName").val() == "") {
            if (errorMessage == "")
                $("#pqSensitiveLoadName").focus();
            errorMessage = errorMessage + "Error " + i + ": " + "PqSensitive Load Name can not be blank <br/>";
            i = i + 1;
            $("#pqSensitiveLoadName").addClass("invalid");
        }
        if ($("#active").val() == "") {
            if (errorMessage == "")
                $("#active").focus();
    ...
    /* $("#btnPqSensitiveLoadCal").unbind().bind("click", function () {
         $("#loading-modal").modal("show");
         $(this).attr("disabled", true);
