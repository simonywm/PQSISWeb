<script>
$(function() {
    $("#aMenuMaintenanceLinkE").addClass("active");
...
<body class="" style="">
    <div class="container" style="margin-top:56px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="eicIdSearchTxt" name="eicIdSearchTxt" type="number" class="form-control" placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-9">
                <input id="eicNameSearchTxt" name="eicNameSearchTxt" type="text" class="form-control" placeholder="" />
            </div>
        </div>
        <br />
        <div class="row">
    ...
    $(function() {
        ...
        table = $("#Table").DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/AjaxGetEicTable",
                "type": "POST",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var btnHtml = "<button id='modifyBtn-" + row.eicId +
                            "' name='modifyBtn' <?php echo $this->viewbag['disabled'] ?> class='btn btn-primary'  eicId='" +
                            row.eicId + "' > Modify</button> ";
                        return btnHtml;
                    },
                    "width": "20%"
                },
    ...
    function constructPostParam(d) {
        var searchParamStr = "{";
        if ($("#eicIdSearchTxt").val() != null && $("#eicIdSearchTxt").val() != "") {
            searchParamStr += "\"eicId\":" + "\"" + $("#eicIdSearchTxt").val() + "\"" + ",";
        }

        if ($("#eicNameSearchTxt").val() != null && $("#eicNameSearchTxt").val() != "") {
            searchParamStr += "\"eicName\":" + "\"" + $("#eicNameSearchTxt").val() + "\"" + ",";
        }
    ...
    function rebindAllBtn() {
        ...
        $("button[name='newBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetEicForNew",
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
        ...
        $("button[name='modifyBtn']").unbind().bind("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Maintenance/GetEicForUpdate&eicId=" +
                    $(this).attr("eicId"),
                type: "GET",
                contentType: 'application/json; charset=utf-8',
                cache: false,
